...
public class ActionTests {
    ...
    public void equalsTestInvalid(long id, String desc) {
        Assertions.assertAll(
                () -> Assertions.assertThrows(Exception.class, () -> Assertions.assertEquals(new Injury(id, desc), new Injury(id, desc))),
                () -> Assertions.assertThrows(Exception.class, () -> Assertions.assertEquals(new PassTo(id, desc), new PassTo(id, desc))),
                () -> Assertions.assertThrows(Exception.class, () -> Assertions.assertEquals(new Scored(id, desc), new Scored(id, desc))),
                () -> Assertions.assertThrows(Exception.class, () -> Assertions.assertEquals(new Penalty(id, desc), new Penalty(id, desc)))
        );
    }
}
