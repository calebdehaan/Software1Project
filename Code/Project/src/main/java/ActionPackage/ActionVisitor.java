...
public class ActionVisitor {
	...
	/**
	 * Increments the catch count for the catcher and completed pass count for the
	 * thrower.
	 *
	 * @param a the action
	 */
	...
	/**
	 * Increments the injury count for the player specified by "a". Also sets
	 * injured status to true.
	 *
	 * @param a the action
	 */
